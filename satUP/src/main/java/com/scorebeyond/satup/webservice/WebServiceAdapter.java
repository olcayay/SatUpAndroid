...
public class WebServiceAdapter {
	...
	public static User getUserObjectFromResponse(Response result) {
		...
		try {
			...
			Gson gson = new Gson();
			user = gson.fromJson(((JsonObject) ((JsonObject) new JsonParser()
	...
	public static Profile getProfileObjectFromResponse(Response result) {
		...
		try {
			...
			Gson gson = new Gson();
			profile = gson
					.fromJson(((JsonObject) ((JsonObject) new JsonParser()
	...
	public static Test getTestObjectFromResponse(Response result) {
		...
		try {
			...
			String bodyResponse = sb.toString();
			Gson gson = new Gson();
			test = gson.fromJson(((JsonObject) ((JsonObject) new JsonParser()
